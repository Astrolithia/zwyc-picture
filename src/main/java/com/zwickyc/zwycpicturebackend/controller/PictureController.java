...
import com.zwickyc.zwycpicturebackend.api.aliyunai.model.GetOutPaintingTaskResponse;
...
import com.zwickyc.zwycpicturebackend.manager.auth.annotation.SaSpaceCheckPermission;
import com.zwickyc.zwycpicturebackend.manager.auth.model.SpaceUserPermissionConstant;
...
public class PictureController {
     ...
     * 本地缓存
     */
    private final Cache<String, String> LOCAL_CACHE = Caffeine.newBuilder().initialCapacity(1024).maximumSize(10_000) // 最大 10000 条
            // 缓存 5 分钟后移除
...
//            }
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPageWithCache(@RequestBody PictureQueryRequest pictureQueryRequest, HttpServletRequest request) {
        ...
        String cacheKey = String.format("zwycpicture:listPictureVOByPage:%s", hashKey);
        // 操作 Redis,从缓存中查询
        ValueOperations<String, String> opsForValue = stringRedisTemplate.opsForValue();
        // 从本地缓存中查询
        // String cacheKey = LOCAL_CACHE.getIfPresent(cacheKey);cacheKey
