package com.zwickyc.zwycpicturebackend.manager;
...
public class FileManager {
    ...
    private void validPicture(MultipartFile multipartFile) {
        ...
        ThrowUtils.throwIf(fileSize > 2 * ONE_M, ErrorCode.PARAMS_ERROR, "文件大小不能超过 2 MB");
        // 2. 校验文件后缀
        ...
        try {
            ...
            if (StrUtil.isNotBlank(contentLengthStr)) {
                try {
                    ...
                    ThrowUtils.throwIf(contentLength > 2 * ONE_M, ErrorCode.PARAMS_ERROR, "文件大小不能超过 2 MB");
