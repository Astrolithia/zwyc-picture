...
const genByTemp = ({ method, path, parameters, status, data, mockConfig, }) => {
...
const genMockFiles = (mockFunction, mockConfig) => {
...
const mockGenerator = ({ openAPI, mockFolder, mockConfig }) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    Object.keys(mockActionsObj).forEach((file) => {
        ...
        if (file.includes('/')) {
            const dirName = path_1.dirname(path_1.join(mockFolder, `${file}.ts`));
            if (!fs_1.default.existsSync(dirName)) {
                fs_1.default.mkdirSync(dirName);
            }
        }
        util_1.writeFile(mockFolder, `${file}.ts`, genMockFiles(mockActionsObj[file], mockConfig));
    });
